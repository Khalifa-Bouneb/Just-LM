...
def load_vocab_merges(path):
    """Load vocab and merges from the saved text file (bpe_vocab_merges_opentext.txt)."""
    vocab = {}
    merges = []
    section = None
...
def main():
    ...
    # LOAD VOCAB + MERGES
    # -----------------------------
    vocab_path = Path("results") / "bpe_vocab_merges_opentext.txt"
    ...
    output_ids_file = results_dir / "openwebtext_encoded_ids.npy"
